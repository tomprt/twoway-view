...
/**
 * Unlike the support library version of this class , this implementation will
 * work in API10 , showing orange overscroll.
 */
public class EdgeEffectCompat {
	 ...
	 */
	static class EdgeEffectPreIcsImpl implements EdgeEffectImpl {
		public Object newEdgeEffect(Context context) {
			return EdgeEffectCompactPreIcs.newEdgeEffect(context);
		}

		public void setSize(Object edgeEffect, int width, int height) {
			EdgeEffectCompactPreIcs.setSize(edgeEffect, width, height);
		}

		public boolean isFinished(Object edgeEffect) {
			return EdgeEffectCompactPreIcs.isFinished(edgeEffect);
		}

		public void finish(Object edgeEffect) {
			EdgeEffectCompactPreIcs.finish(edgeEffect);
		}

		public boolean onPull(Object edgeEffect, float deltaDistance) {
			return EdgeEffectCompactPreIcs.onPull(edgeEffect, deltaDistance);
		}

		public boolean onRelease(Object edgeEffect) {
			return EdgeEffectCompactPreIcs.onRelease(edgeEffect);
		}

		public boolean onAbsorb(Object edgeEffect, int velocity) {
			return EdgeEffectCompactPreIcs.onAbsorb(edgeEffect, velocity);
		}

		public boolean draw(Object edgeEffect, Canvas canvas) {
			return EdgeEffectCompactPreIcs.draw(edgeEffect, canvas);
		}
	}
	...
	/**
	 * Reports if this EdgeEffectCompat's animation is finished. If this method
	 ...
	 * {@link android.view.View#invalidate()} if this method returns true and
	 ...
	 *            effect.
	 * @return true if the host view should call invalidate, false if it should
	 *         not.
	 */
	 ...
	 * should {@link android.view.View#invalidate()} if this method returns true
