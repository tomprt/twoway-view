...
/* Copied from the platform source and change the drawables to orange.
 * No Idea why the support library didn't do it.
 */
 ...
 * </p>
 */
public class EdgeEffectBackport {
	 ...
	 *            the EdgeEffect
	 */
	public EdgeEffectBackport(Context context) {
		final Resources res = context.getResources();
		mEdge = res.getDrawable(R.drawable.overscroll_edge_api10);
		mGlow = res.getDrawable(R.drawable.overscroll_glow_api10);
